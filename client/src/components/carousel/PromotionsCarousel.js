...
function PromotionsCarousel() {
  ...
  return (
    ...
    >
      <div>
        <img src={`${CLOUDINARY_BASE_URL}/images/Barca/Local/Barca_Local_24_3.jpg`} alt={t('Promotion 1')} />
        <p className="legend">{t('Limited time only! 20% off on official FC Barcelona jerseys. Don\'t miss out!')}</p>
      </div>
      <div>
        <img src={`${CLOUDINARY_BASE_URL}/images/Madrid/Madrid_Promocion.jpg`} alt={t('Promotion 2')} />
        <p className="legend">{t('2x1 offer on Real Madrid jerseys! Gear up and share with your friends. Valid while supplies last.')}</p>
      </div>
      <div>
        <img src={`${CLOUDINARY_BASE_URL}/images/Atletico/Local/Atletico_Local_24_3.jpg`} alt={t('Promotion 3')} />
